...
/**
 * ModelutilZIPCode Class Doc Comment
 *
 * @category Class
 * @description The result object containing the ZIP Code. Will always be present if a lookup was successful.
 * @package  GeoCodes
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ModelutilZIPCode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModelutilZIPCode';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['plus_four']) && ($this->container['plus_four'] > 9999)) {
            $invalidProperties[] = "invalid value for 'plus_four', must be smaller than or equal to 9999.";
        }

        if ($this->container['zip'] === null) {
            $invalidProperties[] = "'zip' can't be null";
        }
        if (($this->container['zip'] > 99999)) {
            $invalidProperties[] = "invalid value for 'zip', must be smaller than or equal to 99999.";
        }
    ...
    public function setPlusFour($plus_four)
    {
        ...
        if (!is_null($plus_four) && ($plus_four > 9999)) {
            throw new \InvalidArgumentException('invalid value for $plus_four when calling ModelutilZIPCode., must be smaller than or equal to 9999.');
        }
    ...
    public function setZip($zip)
    {
        ...
        if (($zip > 99999)) {
            throw new \InvalidArgumentException('invalid value for $zip when calling ModelutilZIPCode., must be smaller than or equal to 99999.');
        }
