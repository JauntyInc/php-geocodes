...
/**
 * ModelutilUSAddress Class Doc Comment
 *
 * @category Class
 * @description The address that was matched. This may be different from the input record when the record match was not an exact record match.
 * @package  GeoCodes
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ModelutilUSAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModelutilUSAddress';
    ...
    protected static $openAPITypes = [
        ...
        'formatted' => 'string',
        'state_code' => 'string',
        'street_address' => '\GeoCodes\Model\ModelutilUSStreetAddress',
        'zip_code' => '\GeoCodes\Model\ModelutilZIPCode'
    ];
     ...
     * Gets street_address
     *
     * @return \GeoCodes\Model\ModelutilUSStreetAddress
     */
     ...
     * Sets street_address
     *
     * @param \GeoCodes\Model\ModelutilUSStreetAddress $street_address street_address
     *
     * @return self
     */
     ...
     * Gets zip_code
     *
     * @return \GeoCodes\Model\ModelutilZIPCode
     */
     ...
     * Sets zip_code
     *
     * @param \GeoCodes\Model\ModelutilZIPCode $zip_code zip_code
     *
     * @return self
     */
