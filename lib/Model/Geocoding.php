 ...
 */
class Geocoding implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Geocoding';
    ...
    protected static $openAPITypes = [
        'confidence' => 'int',
        'coordinate' => '\GeoCodes\Model\GCSCoordinate',
        'dataset_citation_required' => 'bool',
        'matched_address' => '\GeoCodes\Model\USAddress',
    ...
    public function setConfidence($confidence)
    {
        ...
        if (($confidence > 100)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling Geocoding., must be smaller than or equal to 100.');
        }
        if (($confidence < 0)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling Geocoding., must be bigger than or equal to 0.');
        }
     ...
     * Gets coordinate
     *
     * @return \GeoCodes\Model\GCSCoordinate|null
     */
     ...
     * Sets coordinate
     *
     * @param \GeoCodes\Model\GCSCoordinate|null $coordinate coordinate
     *
     * @return self
     */
     ...
     *
     * @return \GeoCodes\Model\USAddress
     */
     ...
     *
     * @param \GeoCodes\Model\USAddress $matched_address matched_address
     *
     * @return self
     */
